...
class DirectMessageListItem extends React.Component {
  ...
  handleDelete(e) {
    ...
    App.cable.subscriptions.subscriptions[App.cable.subscriptions.subscriptions.length-2].poof2({ message: this.props.message,  currentUser: this.props.currentUser});
  }
