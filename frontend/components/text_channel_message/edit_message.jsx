...
class EditTextChannelMessageForm extends React.Component {
  constructor(props){
    super(props);
  ...
  handleSubmit(e) {
    ...
    App.cable.subscriptions.subscriptions[App.cable.subscriptions.subscriptions.length-1].update({ message: this.state });
...
export default EditTextChannelMessageForm;